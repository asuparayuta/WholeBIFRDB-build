...
# -*- coding: utf-8 -*-
"""
Import BDBRA-style CSV into WholeBIF-RDB (PostgreSQL). v3
Changes from v2:
- references_tbl.title is now taken **from CSV 'reference'** (forced), per user's rule.
- Other rules remain:
  * reference_id = first 10 chars of 'reference' (or DOI first 10; else generated)
...
def main():
    ap = argparse.ArgumentParser(description="Import CSV into WholeBIF-RDB (references_tbl + connections). v3")
